...
$product_variant = $posterity_a13->get_option( 'shop_products_variant' );
$product_subvariant = $product_variant === 'under'? ('products_subvariant_'.$posterity_a13->get_option( 'shop_products_subvariant' ) ) : '';
...
$lazy_load_mode  = $posterity_a13->get_option( 'shop_lazy_load_mode' );
