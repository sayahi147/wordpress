...
if(!function_exists('posterity_add_menu_parent_class')){
	/**
	 ...
	 * @return array
	 */
	function posterity_add_menu_parent_class( $items ) {
...
add_filter( 'wp_nav_menu_objects', 'posterity_add_menu_parent_class' );


if(!function_exists('posterity_page_menu')){
	/**
	 ...
	 */
	function posterity_page_menu($only_check = false) {
        global $post;
        ...
        if($there_is_menu){
            ...
            $list_pages_params['walker'] = new POSTERITY_list_pages_walker;
